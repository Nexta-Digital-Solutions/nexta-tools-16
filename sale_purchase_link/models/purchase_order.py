            ...
            if bool(origin):
                ...
                if bool(sale_id):
                    ...
                    if bool(sale_line_id):
                        values['sale_line_id'] = sale_line_id.id

        res = super(PurchaseOrder, self)._prepare_purchase_order_line_from_procurement(product_id, product_qty, product_uom, company_id, values, po)
        return res
