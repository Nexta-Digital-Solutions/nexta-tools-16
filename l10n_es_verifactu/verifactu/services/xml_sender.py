    ...
    def send(self, signed_xml_str, attachment):
        ...
        try:
            ...
            if status == "sent":
                ...
                invoice._log_verifactu_status("sent",code)
                try:
                ...
                invoice.verifactu_date_sent = now
                invoice._log_verifactu_status("accepted_with_errors",code)
                try:
                    self._save_snapshot_after_send(invoice)
                except Exception:
                    pass
                ...
                invoice.verifactu_date_sent = now
                invoice._log_verifactu_status("canceled",code)
                ...
                invoice.verifactu_processed = False
                invoice.verifactu_status = "error"
                invoice._log_verifactu_status("error",code)
