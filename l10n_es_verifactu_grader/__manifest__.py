{
    "name": "Veri*Factu - Integración con la AEAT (España) - Grader",
    "id":"l10n_es_verifactu_grader",
    "version": "2.2.0",
    "author": "Mr Rubik",
    "maintainer": "Mr Rubik",
    ...
    "currency": "USD",
    "category": "Accounting",
    "summary": "Integración técnica con AEAT mediante Veri*Factu para facturas electrónicas (versión Grader).",
    "description": """
...
"external_dependencies": {
    ...
    "assets": {
        "web.assets_backend": [
            "l10n_es_verifactu_grader/static/src/css/verifactu_styles.css",
        ],
    },
    "installable": True,
    "application": False,
